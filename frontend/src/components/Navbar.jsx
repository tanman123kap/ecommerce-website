...
const Navbar = () => {
  ...
  return (
    <div className="flex item-center justify-between py-5 font-medium">
      ...
      <ul className="hidden my-auto sm:flex gap-5 text-sm text-gray-700 hidden">
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8x]">{getCartCount()}</p>
        </Link>
